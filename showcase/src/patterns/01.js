...
const withClapAnimation = WrappedComponent => {
  class WithClapAnimation extends React.Component {
    ...
    // }
    initialAnimationTimeline = new mojs.Timeline()
    state = {
      animationTimeline: this.initialAnimationTimeline
    }
    ...
    componentDidMount() {
      ...
      const newAnimationTimeline = this.initialAnimationTimeline.add([scaleButton, countTotalAnimation])
